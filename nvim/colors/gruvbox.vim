...
let s:p.normal.left = [ [ s:term_colo5, s:term_colo2, 'bold' ], [ s:term_colo16, s:term_colo2, ] ]
...
let s:p.insert.left = [ [ s:term_colo3, s:term_colo2, 'bold' ], [ s:term_colo16, s:term_colo2, ] ]
let s:p.insert.right = [ [ s:term_colo2, s:term_colo3, ], [ s:term_colo3, s:term_colo2, ], [ s:term_colo16, s:term_colo2, ] ]

let s:p.replace.left = [ [ s:term_colo12, s:term_colo2, 'bold'  ], [ s:term_colo16, s:term_colo2, ] ]
let s:p.replace.right = [ [ s:term_colo15, s:term_colo12, ], [ s:term_colo16, s:term_colo2, ], [ s:term_colo16, s:term_colo2, ] ]

let s:p.visual.left = [ [ s:term_colo10, s:term_colo2, 'bold' ], [ s:term_colo16, s:term_colo2, ] ]
