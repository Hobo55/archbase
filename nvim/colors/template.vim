...
" =============================================================================
" Filename: autoload/lightline/colorscheme/template.vim
" Last Change: 10/2/2020 
" =============================================================================

" Use this file as a guide to make your own lightline theme
" Change colors using HEX number and XTerm number
" Arrange inside bar segments
" Note: change theme name in last line <filename> 
...
let g:lightline#colorscheme#filename#palette = lightline#colorscheme#flatten(s:p)
