" =============================================================================
" Filename: autoload/lightline/colorscheme/duomini.vim (for vim colorscheme duo-mini)
" =============================================================================
...
let s:term_grey = 232
let s:term_grey2 = 244
let s:term_purple = 170
let s:term_red = 125
let s:term_white = 145
let s:term_white2 = 223
let s:term_yellow = 180
let s:term_orange = 215
...
let s:p.inactive.right = [ [ '#292c33', '#61afef', s:term_white, s:term_grey ], [ '#abb2bf', '#3e4452', s:term_black, s:term_grey2 ] ]
...
let s:p.replace.left = [ [ '#292c33', '#e06c75', s:term_white2, s:term_red, 'bold' ], [ '#e06c75', '#292c33', s:term_red, s:term_black ] ]
...
let s:p.visual.left = [ [ '#292c33', '#c678dd', s:term_black, s:term_orange, 'bold' ], [ '#c678dd', '#292c33', s:term_orange, s:term_black ] ]
let s:p.visual.right = [ [ '#292c33', '#c678dd', s:term_black, s:term_orange, 'bold' ], s:p.normal.right[1], [ '#c678dd', '#292c33', s:term_orange, s:term_black ] ]
...
let g:lightline#colorscheme#duomini#palette = lightline#colorscheme#fill(s:p)
