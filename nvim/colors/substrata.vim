" =============================================================================
" Filename: autoload/lightline/colorscheme/substrata.vim
" Author: arcticicestudio
" License: MIT
" Last Change: 2017/11/12 20:27:51
" =============================================================================
"exta colors= #a18daf,  #262930 #4C566A
...
let s:nord13 = ["#E8CF9E", 3]
let s:nord14 = ["#A3BE8C", 2]
let s:nord15 = ["#B48EAD", 5]
let s:nord16 = ["#5f5f87", "NONE"]

let s:p.normal.left = [ [ s:nord6, s:nord3 ], [ s:nord5, s:nord1 ] ]
...
let s:p.inactive.left =  [ [ s:nord1, s:nord5 ], [ s:nord5, s:nord1 ] ]
let s:p.inactive.middle = [ [ s:nord5, s:nord1 ] ]
let s:p.inactive.right = [ [ s:nord5, s:nord1 ], [ s:nord5, s:nord1 ] ]

let s:p.insert.left = [ [ s:nord1, s:nord8 ], [ s:nord5, s:nord1 ] ]
let s:p.replace.left = [ [ s:nord1, s:nord15 ], [ s:nord5, s:nord1 ] ]
...
let g:lightline#colorscheme#substrata#palette = lightline#colorscheme#flatten(s:p)
